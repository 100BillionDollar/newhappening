...
import Aboutbanner from "/public/assets/images/about_banner.jpg";
    ...
    <div className="banner-wrapper position-relative text-white">
      ...
      <div className="container h-100 position-absolute caption_box">
        <div className="row h-100">
          <div className="col-12 d-flex flex-column justify-content-center"  data-aos="fade-up" data-aos-delay="400">
